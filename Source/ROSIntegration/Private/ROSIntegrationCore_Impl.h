...
// UImpl::Impl needs to be moved here from ROSIntegrationCore, because there was a forward declaration as a variable,
// in UImpl, but the actual definition was nested within the class, so when other files tried to call
// functions from the class,they couldn't find the definition, because they didn't get it until after that declaration
// so it needs to be defined separately in its own file
